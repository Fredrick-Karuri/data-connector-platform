...
function ExtractPageInner() {
  ...
  const isRunning =
    extraction.status === "PENDING" || extraction.status === "PROGRESS";
  ...
  return (
    <div className={s.page}>
      ...
      <aside
        className={`${s.queryPanel} ${panelOpen ? s.queryPanelOpen : s.queryPanelClosed}`}
      >
        <div className={s.panelHeader}>
          ...
          {submitResult && (
            <a className={s.fileLink} href="/files">
              View file ↗
            </a>
          )}
        </div>
        ...
        <label className={s.fieldLabel}>
          Batch size{" "}
          <span className={s.fieldHint}>max {MAX_BATCH.toLocaleString()}</span>
        </label>
        <div className={s.batchRow}>
          ...
          <input
            ...
            value={batchSize}
            onChange={(e) =>
              setBatchSize(Math.min(Number(e.target.value), MAX_BATCH))
            }
        ...
        <div className={s.panelNav}>
          <a href="/connections" className={s.navLink}>
            ← Connections
          </a>
          <a href="/files" className={s.navLink}>
            Files →
          </a>
        </div>
      </aside>
